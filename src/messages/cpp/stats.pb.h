...
inline ::google::protobuf::uint32 Stats::count() const {
  // @@protoc_insertion_point(field_get:protbuf.Stats.count)
  return count_;
}
inline void Stats::set_count(::google::protobuf::uint32 value) {
  set_has_count();
  count_ = value;
  // @@protoc_insertion_point(field_set:protbuf.Stats.count)
}
...
inline ::google::protobuf::uint64 Stats::totaltime() const {
  // @@protoc_insertion_point(field_get:protbuf.Stats.totalTime)
  return totaltime_;
}
inline void Stats::set_totaltime(::google::protobuf::uint64 value) {
  set_has_totaltime();
  totaltime_ = value;
  // @@protoc_insertion_point(field_set:protbuf.Stats.totalTime)
}
...
inline ::google::protobuf::uint64 Stats::executiontime() const {
  // @@protoc_insertion_point(field_get:protbuf.Stats.executionTime)
  return executiontime_;
}
inline void Stats::set_executiontime(::google::protobuf::uint64 value) {
  set_has_executiontime();
  executiontime_ = value;
  // @@protoc_insertion_point(field_set:protbuf.Stats.executionTime)
}
